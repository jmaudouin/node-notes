module.exports = (query) => {
  console.log(query)
  var dicoAnagrammes = require('./dicos')(query.lg)


  var tailleMotMini = Number(query.taille)
  var exclus = query.exclus.split('-')
  ...
  /*
    ...
    */
  	//if(e.data[0] == "chercheParMots"){
  		...
  		// 	dicoAnagrammes = dicoAnagrammesEn
  		// }
  		return chercheParMots(query.input,tailleMotMini,exclus,query.input.length)
  		//self.postMessage("calcultermine");
  	//}
    /*
